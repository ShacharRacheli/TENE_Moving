...
import { Email, Lock, LoginOutlined, Visibility, VisibilityOff } from "@mui/icons-material";
import { alpha, Box, Button, Fade, IconButton, InputAdornment, Paper, TextField, Typography } from "@mui/material";
    ...
    return(<>
        <Paper
          ...
          sx={{
            ...
            overflow: "hidden",
            outline: "none",
            background: "linear-gradient(135deg, #e0f5f5 0%, #ffffff 50%, #c2e8e8 100%)",
boxShadow: "0 25px 50px -12px rgba(0, 0, 0, 0.2), 0 0 0 1px rgba(255, 255, 255, 0.04)",
        ...
        >
          <Box
            sx={{
              ...
              height: 128,
              borderRadius: "50%",
background: "linear-gradient(135deg, #a8eaea 0%, #7fd3d3 100%)", // top bubble
              opacity: 0.6,
            }}
          />
          <Box
            sx={{
              ...
              height: 96,
              borderRadius: "50%",
background: "linear-gradient(135deg, #d4f4f4 0%, #b3e9e9 100%)", // bottom bubble
              opacity: 0.4,
            }}
          />
    ...
    : `0 0 0 3px ${alpha("#2d7d7d", 0.15)}`,
              ...
              <Button
                ...
                sx={{
                 ...
                 background: "linear-gradient(135deg, #2d7d7d 0%, #3ea3a3 100%)",
"&:hover": {
  background: "linear-gradient(135deg, #3ea3a3 0%, #2d7d7d 100%)",
